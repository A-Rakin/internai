...
# ============================================================
# EMAIL CONFIGURATION (SMTP Server Integration)
# ============================================================
# SMTP configuration using decouple.config for environment override
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='InternAI <noreply@internai.com>')
